...
$$1.extend($$1.summernote.lang, {
    'en-US': {
        ...
        image: {
            image: 'Picture',
            insert: 'Chèn Hình Ảnh Vào Bài Viết',
            ...
            dragImageHere: 'Kéo Hình Ảnh Vào Đây',
            dropImage: 'Drop image or Text',
            selectFromFiles: 'Lựa Chọn Hình Ảnh',
            maximumFileSize: 'Maximum file size',
            maximumFileSizeError: 'Maximum file size exceeded.',
            url: 'Sử Dụng Link Hình Ảnh',
            remove: 'Remove Image',
            original: 'Original'
        },
        video: {
...
var Editor = /** @class */ (function () {
    ...
    Editor.prototype.insertImages = function (files) {
        ...
        $$1.each(files, function (idx, file) {
            ...
            // uploadFileCloudinarySummernote2(file, _this.insertImage);
            // _this.insertImage("http://whitecompany.scene7.com/is/image/whitecompany/HYTDA_15_MAIN?$TP_PDP_586x586$", "gokisoft.com");
            ...
            var url = arr[0];//url_upload;//`https://api.cloudinary.com/v1_1/gokisoft-com/upload`;
              ...
              xhr.onreadystatechange = function(e) {
                if (xhr.readyState == 4 && xhr.status == 200) {
                  ...
                  _this.insertImage(url, "gokisoft.com");
                }
              };
